...
Collections are the source of truth. This index describes which collections are the best starting points for each resource type; it deliberately does not duplicate the entries contained in them.
...
| News and product updates | [Daily news archive](../daily_news/README.md) |

For a domain-first path, use [Browse by Topic](by-topic.md).
