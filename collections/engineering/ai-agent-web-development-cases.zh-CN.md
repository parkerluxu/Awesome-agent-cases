...
以下为新增资料线索，按内容类型分组，供后续文章迭代参考。

### 项目

| 名称 | 类型 | 用途/摘要 | 链接 |
|------|------|-----------|------|
| dsh-verify | GitHub 项目 | Agent 构建 Web 应用的质量门禁，提供真实浏览器验收检查，支持 CLI、MCP（Claude Code / Cursor / Copilot）及 GitHub Action | https://github.com/263311487-ux/dsh-verify |
| devv | GitHub 项目 | AI 编码 Agent 与即时后端平台，支持从自然语言提示构建全栈 AI Web 应用，定位为无代码应用构建器 | https://github.com/api-evangelist/devv |
| agent-device | GitHub 项目 | 面向 AI 编码 Agent 的移动应用自动化与验证工具，提供 CLI、MCP Server 及类型化 Node.js API，支持 iOS、Android、HarmonyOS、TV、Web、macOS、Linux | https://github.com/callstack/agent-device |
| bolt-new | GitHub 项目 | StackBlitz 的浏览器内 AI 全栈应用构建器，基于 WebContainer 运行时在浏览器标签页内生成、编辑、运行并部署完整 Web 应用 | https://github.com/api-evangelist/bolt-new |
| b12 | GitHub 项目 | AI 驱动的网站构建器，可从简短提示生成专业网站、在线商店和 Web 应用，采用 human-in-the-loop 模式 | https://github.com/api-evangelist/b12 |
| memi | GitHub 项目 | 面向 Agentic AI 的设计层，为编码 Agent 提供设计上下文、界面检查与验证能力 | https://github.com/memi-design/memi |
| openchamber | GitHub 项目 | OpenCode AI Agent 的桌面端与 Web 界面 | https://github.com/openchamber/openchamber |
| paseo | GitHub 项目 | 从桌面端和移动端编排多个编码 Agent | https://github.com/getpaseo/paseo |
| modern-web-guidance | GitHub 项目 | Google Chrome 团队维护，帮助编码 Agent 保持与最新 Web 最佳实践同步 | https://github.com/GoogleChrome/modern-web-guidance |

### 论文 / Benchmark

| 名称 | 类型 | 用途/摘要 | 链接 |
|------|------|-----------|------|
| Comparing the Quality of Code Generated by Vibe Coding Tools | arXiv 论文 | 对比 Lovable、v0、Replit 三种 vibe coding 工具生成代码的结构质量，从单一生成提示出发，每工具生成三个独立项目，共九个 Web 应用 | https://arxiv.org/abs/2608.16302v1 |
| Tencent WorkBuddy Bench | arXiv 论文 | 多领域编码 Agent 评测套件，覆盖 Code、Web、Office、Security 四个工作域，任务从真实 commit、PR 或业务场景逆向构建，具备抗污染特性 | https://arxiv.org/abs/2607.20911v1 |
| VideoVIBE | arXiv 论文 | 视频驱动的诊断基准，将人工操作的网页录制转换为细粒度诊断任务，用于评估一次性交互式网站生成质量，包含约 1.7K 诊断视频 | https://arxiv.org/abs/2608.09573v1 |
| MT-Web2Code | arXiv 论文 | 首个面向多轮区域重建与局部修改的多模态编码基准，模拟真实前端工程中在既有代码库内反复重建缺失区域和修改局部元素的迭代工作流 | https://arxiv.org/abs/2608.03474v1 |
| Vibe Coding: An Experiment with Test-Driven Development | arXiv 论文 | 探索性研究，设计四种交互模型，考察人类与 CLLM 通过 vibe coding 进行对等协作时测试驱动开发的效果 | https://arxiv.org/abs/2607.22406v1 |
| Agentic Commerce World | arXiv 论文 | 面向 vibe commerce 的可审计、可验证环境，Buyer 与 Merchant Agent 在共享市场中独立交互并保持私有目标与权限 | https://arxiv.org/abs/2608.02441v1 |
| An Empirical Study of Coordination Mode in From-Scratch Multi-Agent Coding | arXiv 论文 | 提出 MSEval 基准，基于 10 个真实全栈项目评估多 Agent 编码，使用分层需求与确定性评分，关注实际时间与金钱成本 | https://arxiv.org/abs/2607.27877v1 |
| WebGrader | arXiv 论文 | 自进化程序化评分器，用于训练 LLM 进行 Web 开发，解决强化学习中奖励设计的瓶颈问题 | https://arxiv.org/abs/2608.06474v1 |

### 教程 / 媒体实测

| 名称 | 类型 | 用途/摘要 | 链接 |
|------|------|-----------|------|
| Vibe Coding 保姆级完整教程 | Bilibili 视频 | 2026 最新 Vibe Coding 实战教程，涵盖 Codex、Claude Code、Cursor 等工具 | https://news.google.com/rss/articles/CBMiV0FVX3lxTE1Yb1h4eEVCdk5DZWR3aUp4U1RURGRuM1NvektRY1FyT2tLLXhRNkJwMVM4OW9tcV8xRDZ3NVlQNDdHdUJMVU5haVdSeWYybVM5MG1sNHdMVQ?oc=5 |
| DeepSeek Harness 教程：一切皆插件的开源 Agent 框架 | 知乎专栏 | 介绍 DeepSeek Harness 开源 Agent 框架的插件化设计与使用 | https://news.google.com/rss/articles/CBMiXEFVX3lxTE81aDdWdjZOaUhvWGRTRzB0dnR1WlZmLVA1SmlqRHk0aGNEWjdpUkZEX3lsUFFHSjhFdllkVUJsMmRkd2Z3VmFRNmV0T19ZVHU0US1xdmdLS3MwallI?oc=5 |
| Claude Code、OpenAI Codex 与 DeepSeek Harness 架构对比 | 积墨 AI | 三款主流 AI 编程工具/框架的架构对比分析 | https://news.google.com/rss/articles/CBMingFBVV95cUxQbjZPb3Y1bm5YRnFyYWlnZ0FMM3FCcjBHX2tyLWF6ekpKMmFIdmFMV2FXUHNvaDBrMVhCRmtCZmYxYktjQVBydUJ5eXZoNXJxektRR3BZZzk1VkJkZDNSeE9PYmd6Yk1OdWt4MnZ5WFAySVFKdGs2MXVDQll5d0xiNGtlMkx0SXlKVHk2eDY5WHJyN18xbWlyNXdGWlJWUQ?oc=5 |
| DeepSeek Harness 深度体验 | OSCHINA | 15 万星 Agent 框架的部署教程、模型接入与插件生态解析 | https://news.google.com/rss/articles/CBMiWkFVX3lxTE9BUWhSTzVxRXdLUGFxdGlhdlRxTHpSeHhjeWxoRTdoZWRUXzhFR2trZ3d2aTdMNnlibmsxLVFnbzF4MS1rclcySktQbV91S1VfVGVqRVlxUzdzUQ?oc=5 |
| Nvidia：harness 而非 AI 模型才是真正的英雄 | TechCrunch | Nvidia 研究显示，通过 fine-tuning，即使 AI 模型本身能力一般，Agent 也能表现良好 | https://techcrunch.com/2026/08/21/nvidia-just-showed-that-the-harness-not-the-ai-model-is-now-the-real-hero/ |
| 75% of developers prefer Claude Code | ZDNET | 开发者调研：75% 受访开发者偏好 Claude Code 而非 Codex 的原因分析 | https://news.google.com/rss/articles/CBMihwFBVV95cUxNOHFPM0lRU2R5WFQ0ZGJmcWdnUWZhN2dBbTE0T1JCZ3NuS1pFcXExMllXaWc3Wk1mT0RVOWRWU3FZcmdQaDZQLUZHUkdCUTdkcTJJM3lkR21kYmhKeWp6TTg0dkZMWHF0M3FCR2JLUDhRVXFaUFVVNzctby05VVZDRmhRNTNOOWc?oc=5 |

### 产品 / 工具

| 名称 | 类型 | 用途/摘要 | 链接 |
|------|------|-----------|------|
| OpenConnector | 开源连接器网关 | 面向 AI Agent 和应用开发者的开源连接器网关，解决认证管理、权限控制、接口适配和运行审计等问题，支持 1000+ SaaS 服务 | https://www.oschina.net/news/502067/oomol-lab-open-connector |
