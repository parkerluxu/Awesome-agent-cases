...
The following resources were identified after the original article was published. They are provided as leads for further exploration.

### Projects

| Name | Type | Use / Summary | Link |
|------|------|---------------|------|
| oaslananka/kicad-mcp-pro | GitHub | AI-ready MCP server for KiCad: automate schematic, PCB, ERC/DRC, DFM, BOM and manufacturing review from Claude, Cursor, Copilot and other AI agents. | https://github.com/oaslananka/kicad-mcp-pro |
| sjrai007/spec-to-gds | GitHub | Spec in, verified GDSII out — an autonomous Claude Code agent for RTL-to-GDS chip design. No human in the loop. Native OpenROAD on Apple Silicon, no Docker. | https://github.com/sjrai007/spec-to-gds |
| shsridhar-beep/svgap | GitHub | Evidence profiles for AI-generated RTL; research collaborators and design partners welcome. Alpha research software, seeking validation. | https://github.com/shsridhar-beep/svgap |
| ArchanaChetan07/llm-hdl-bench | GitHub | LLM RTL-generation benchmark: 46 SystemVerilog prompts x 5 categories, dual-tool gate (Yosys lint/synthesis + Icarus Verilog simulation) before any pass counts; typed failure verdicts in SQLite, one-command Docker reproduction, GitHub Actions CI, Python harness. | https://github.com/ArchanaChetan07/llm-hdl-bench |
| ShenShan123/r2g-skills | GitHub | Agent skill R2G. Initial version for leveraging OpenRoad. | https://github.com/ShenShan123/r2g-skills |
| ZMYsamuel/ICCAD2026_Problem-A_Benchmark | GitHub | Community submission archive for ICCAD 2026 Problem A — LLM-Assisted Netlist Exploration and Transformation. | https://github.com/ZMYsamuel/ICCAD2026_Problem-A_Benchmark |
| openecos-projects/ecc | GitHub | A Chip Design Automation Solution with Open Source EDA Tools. | https://github.com/openecos-projects/ecc |
| amoslee2026/Babel | GitHub | AI-native Chiplet design flow based on open-source EDA toolchain. | https://github.com/amoslee2026/Babel |

### Papers / Benchmarks

| Name | Type | Use / Summary | Link |
|------|------|---------------|------|
| Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows | arXiv | Evaluates AI agents on a PicoRV32 RTL-to-GDS flow using commercial EDA tools, examining whether general-purpose coding agents with domain-specific EDA skills can execute end-to-end synthesis, physical implementation, and ECO optimization. | https://arxiv.org/abs/2607.17528v3 |
| LLM for EDA in Front-End Design: Challenges and Opportunities | arXiv | Explores LLMs as a unified intelligent interface for HDL generation, testbench construction, and design space exploration in front-end design. | https://arxiv.org/abs/2607.09616v1 |
| Benchmarking LLMs for Verilog Design Flows | arXiv | Reproducible benchmarking platform evaluating open-source LLMs on Verilog RTL generation across 50 curated tasks (combinational, sequential, finite state machines) with end-to-end toolchain validation. | https://arxiv.org/abs/2607.22759v1 |
| GoGoTB: Agentic RTL Verification with Specification-Grounded Coverage Closure | arXiv | Agentic framework for functional verification with shared context across components, addressing interface mismatches and connecting coverage to specification requirements. | https://arxiv.org/abs/2607.26181v1 |
| RF-Agent: A Practical Framework for Building Language Agents for RFIC Design | arXiv | Textbook-driven knowledge distillation framework for RF circuit design; multi-agent QTSA pipeline converts seven canonical RF textbooks into a domain-specific dataset. | https://arxiv.org/abs/2607.18772v1 |
| CLOSER-Bench: Evaluating Budgeted Cross-Stage Design Closure for Hardware Agents | arXiv | Benchmark for long-horizon hardware engineering work with continuous progress, delayed heterogeneous tool feedback, and cross-stage failures (e.g., backend failure requiring RTL revision). | https://arxiv.org/abs/2607.16632v1 |
| VPR-Evolve: Multi-Agent-Driven Algorithm Evolution for FPGA Place and Route | arXiv | Multi-agent framework that evolves CAD algorithms for FPGA place-and-route rather than merely tuning hyperparameters, targeting design-specific specialization. | https://arxiv.org/abs/2607.24998v1 |
| ChipVerilog: A Large-Scale OpenCores-Derived Benchmark for LLM-Based Verilog RTL Generation | arXiv | Description-to-Verilog generation benchmark built from OpenCores IP/core designs; 64 generation targets capturing code scale, hierarchy, and module interactions of practical RTL. | https://arxiv.org/abs/2607.13079v2 |
| VClare: Resolving Imperfect Specifications in LLM-Based Verilog Generation | arXiv | First systematic study of imperfect specifications (vagueness, contradictions, incompleteness) and an automated framework to repair them for improved LLM-based hardware design. | https://arxiv.org/abs/2607.24854v1 |
| Towards Reliable AI-Assisted Analog Design: Template-Constrained LLM Agents for SAR ADC Generation | arXiv | End-to-end, multi-step LLM agentic framework (ATLAS) for analog EDA using template constraints to avoid hallucinations and produce schematics passing SPICE simulations. | https://arxiv.org/abs/2607.14165v1 |
| ARES: Adaptive Reasoning-Effort Steering for PPA- and Cost-Aware RTL Optimization with LLM Agents | arXiv | Introduces normalized dollar cost per LLM call, adaptive reasoning-effort steering, and addresses the trade-off between PPA quality and cost in RTL optimization agents. | https://arxiv.org/abs/2607.27879v1 |

### Tutorials / Media Tests

| Name | Type | Use / Summary | Link |
|------|------|---------------|------|
| Kimi K3 Demonstrates 48-Hour Autonomous Chip Design | News | Reports Kimi K3 demonstrating 48-hour autonomous chip design, accelerating EDA industry into the AI agent era. | https://news.google.com/rss/articles/CBMidkFVX3lxTE01bmlyMkJ1YkFVa3dvdEV3bElqRkw2M1VteV9tN1RjQjFKWDlnMXROLUUtb2ZkRTAwajhlRDQxRV9YQWk3UGMyWk5CbUJsTFA4aGtfajlLWVZTTWg5TXVJYjl0NlNDazF1QnpUcXE4bFN4RlYxNFE?oc=5 |
| Synopsys, NVIDIA Advance Autonomous AI Agents for Chip Design and Engineering | News | EE Times Asia report on Synopsys and NVIDIA advancing autonomous AI agents for chip design and engineering. | https://news.google.com/rss/articles/CBMiowFBVV95cUxQWmM1cEd1YkdzTGx1UDNhOEVKbTZEclRMaHdyVmRQZ09LZWtMLXlXSFJZaDZfV05yWTVMTkpicE9MMnVCbkRNZmVKbC1FcnVQclBodHl1alhMczRLYTY5YktBRXVwTERJMEFfQWJGZHRYa3liQXFJbjU1NXA0Y1hiMDhoZElzcGpGdlVjZUlyeHhDOElnbl9NLThWMlA4TjJsR21n?oc=5 |
| Cadence Expands AI Agents With AuraStack For PCB And Advanced Chip Packaging | News | Forbes report on Cadence expanding AI agents with AuraStack for PCB and advanced chip packaging. | https://news.google.?oc=5 |
| AI Agent 设计出量产级芯片！（详细流程） | Article | Chinese-language article detailing the process of AI agents designing production-grade chips. | https://news.google.com/rss/articles/CBMiXEFVX3lxTFAtX3Fkd09IenNacS1MQzlJMFR2RDQ3cnpjZm1Famg2UXFIVDhSSTdJRW9LMmxFUzh6M1ZyWUxacWFCQVNxWWx4WndGX0p1RU9SWm05ZUJaTEQ1eThR?oc=5 |
| Benchmarking Open-Source LLMs on Verilog RTL Generation Across 50 Tasks | News | Semiconductor Engineering report on benchmarking open-source LLMs on Verilog RTL generation across 50 tasks (NMIMS, IIT Roorkee, BITS Pilani). | https://news.google.?oc=5 |
| Synopsys, Cadence, and Siemens Take Agentic Chip Design Autonomous at DAC | News | The Futurum Group report on Synopsys, Cadence, and Siemens taking agentic chip design autonomous at DAC. | https://news.google.com/rss/articles/CBMiqgFBVV95cUxNVlhoNHRNUW1OYkc3UU54SGpJX3JPZUJVR1RkRnl6MWVONkZfM3pfeUJoRHdfT3pvcU92anh1NmVPMEpFYVlnaDRpVHpxM0EzTGZ3YkZ0a2kyQTZULW85R1VPam9MTUJKQUhyWEF6TjBCXzF2eExoZENMMDhnbFh5LVZDZVJZWDd5bGl5TEN0N2draDhyelc5MHMzTWprWjl3ZXBlTlZXMnU4dw?oc=5 |
| 芯和半导体携手联想集团在DAC 2026现场发布EDA Agent最新研发成果 | News | Chinese-language report on Xpeedic Semiconductor and Lenovo releasing EDA Agent research results at DAC 2026. | https://news.google.com/rss/articles/CBMiUkFVX3lxTE5pcjh6THk1Rko3MGhhaFBYbDdSazJITTFfMm85dnBsa0NOdDdxaUpZQkNTZ0xOOWt0eXJob19RaUh1NElncU1taHRvVEd4QllOdVE?oc=5 |
| NVIDIA Nemotron 3 Ultra Leads Open Models on Accuracy and Efficiency in Agentic RTL Coding | News | NVIDIA Developer report on Nemotron 3 Ultra leading open models on accuracy and efficiency in agentic RTL coding. | https://news.google.?oc=5 |
| DAC 2026 Live: AI Chip Design Agents Hit Production as Nobel Laureate Joins the Debate | News | Tech Times report on AI chip design agents hitting production at DAC 2026. | https://news.google.?oc=5 |
| Siemens Hooks Chip Design Agents to Physics Engines to Prevent Tapeout Errors | News | Tech Times report on Siemens connecting chip design agents to physics engines to prevent tapeout errors. | https://news.google.?oc=5 |
| DAC 2026 AI+EDA 全景资源图 | Article | Chinese-language comprehensive resource map of AI+EDA at DAC 2026. | https://news.google.com/rss/articles/CBMiU0FVX3lxTE94cGJKWDRTbDlEQTB2N3J5U21hZEJ3M1RMSDVrX3kxenRvRVprZlpJOUtoemgzUDZWV0lIYWpNVEVyRlJuMlE4QVVaeF9qc3BMMERZ?oc=5 |
