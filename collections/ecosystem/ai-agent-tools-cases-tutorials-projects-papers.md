...
<!-- AUTO_LATEST_RESOURCES_START -->
## Latest Auto-Discovered Resources

Updated: 2026-06-09

This section is generated automatically from recent GitHub, arXiv, and Google News searches. Entries are candidates for follow-up reading and may need manual curation.

### Open-source projects

| Date | Resource | Source | Why It Matters |
|---|---|---|---|
| 2026-05-27 | [withkynam/vibecode-pro-max-kit](https://github.com/withkynam/vibecode-pro-max-kit) | GitHub, 832 stars, JavaScript | Your AI forgets. This remembers. Spec-driven coding harness for vibecoders, product owners, CEOs and real builders — self-improving context memory, 12 agents, 32 skills. Kills c... |
| 2026-05-27 | [nexu-io/html-video](https://github.com/nexu-io/html-video) | GitHub, 2447 stars, HTML | Programmatic video for coding agents — HTML to video on your laptop. Turn HTML, CSS & data into real MP4s with pluggable render engines, 21 templates, AI soundtrack. Apache-2.0,... |
| 2026-06-06 | [amElnagdy/guard-skills](https://github.com/amElnagdy/guard-skills) | GitHub, 498 stars, unknown | Guard skills for coding agents, quality gates that catch AI-generated failure modes in code, tests, and docs |
| 2026-06-03 | [razr001/align-dev](https://github.com/razr001/align-dev) | GitHub, 351 stars, TypeScript | AlignDev helps AI-assisted frontend teams generate shared coding standards and SKILL.md so Claude Code, Codex, Cursor, Copilot, and other agents write consistently. |
| 2026-06-03 | [tastyeffectco/sandboxd](https://github.com/tastyeffectco/sandboxd) | GitHub, 528 stars, Go | Self-hosted dev sandboxes with preview URLs. One command. No Kubernetes, perfect for coding agents and Saas factories |
| 2026-05-27 | [fayazara/macos-app-skills](https://github.com/fayazara/macos-app-skills) | GitHub, 506 stars, Swift | AI coding agent skills for building, shipping, and maintaining native macOS apps |
| 2026-06-07 | [JimLiu/baoyu-design](https://github.com/JimLiu/baoyu-design) | GitHub, 613 stars, JavaScript | Run Claude Design locally as an Agent Skill — Cursor, Claude Code & more. Produce polished UI mockups, prototypes, decks & wireframes as self-contained HTML, without claude.ai/d... |
| 2026-05-28 | [modelstudioai/cli](https://github.com/modelstudioai/cli) | GitHub, 215 stars, TypeScript | Official Model Studio CLI（阿里云百炼 CLI）built for AI Agent frameworks, exposing models, search, multimodal, and workflow capabilities as structured tool calls. |
| 2026-05-27 | [robzilla1738/harness-terminal](https://github.com/robzilla1738/harness-terminal) | GitHub, 280 stars, Swift | The native macOS terminal that keeps your sessions running and tells you when a coding agent needs you. GPU-rendered, scriptable, agent-aware. |
| 2026-05-28 | [K-Dense-AI/science-superpowers](https://github.com/K-Dense-AI/science-superpowers) | GitHub, 196 stars, Shell | Composable computational-science methodology skills for AI research agents — pre-registration over TDD. A science-domain reimplementation of Superpowers. |
| 2026-05-26 | [doiito/gliding_horse](https://github.com/doiito/gliding_horse) | GitHub, 65 stars, Rust | Gliding Horse is a multi-agent orchestration framework built in Rust that supports PDCA scheduling and knowledge graph-based agents, with comprehensive Chinese documentation, an... |
| 2026-05-26 | [Fincept-Corporation/Quantcept](https://github.com/Fincept-Corporation/Quantcept) | GitHub, 20 stars, TypeScript | Your AI research analyst, in the terminal. Open-source agentic CLI for markets, portfolios, risk & quant analysis. |

### Papers and benchmarks

| Date | Resource | Source | Why It Matters |
|---|---|---|---|
| 2026-06-08 | [What Should a Skill Remember? Quality-Cost Trade-offs in Cost-Aware Skill Rewriting for Language Model Agents](https://arxiv.org/abs/2606.09421v1) | arXiv | Large language model agents increasingly rely on skills: reusable procedural documents encoding workflows, tool use, implementation patterns, validation checks, and domain rules... |
| 2026-06-08 | [Autonomous Incident Resolution at Hyperscale: An Agentic AI Architecture for Network Operations](https://arxiv.org/abs/2606.09122v1) | arXiv | Cloud network infrastructure at hyperscale presents unique operational challenges where traditional human-driven incident response cannot keep pace with the volume, velocity, an... |
| 2026-06-08 | [Context-Fractured Decomposition Attacks on Tool-Using LLM Agents: Exploiting Artifact Provenance Gaps](https://arxiv.org/abs/2606.09084v1) | arXiv | Tool-using LLM agents interact with the world through actions that persist state in artifacts (e.g., workspace files or logs). Consequently, jailbreak defenses must reason about... |
| 2026-06-06 | [Toward Human-Centered Multi-Agent Systems: Integrating Cognition, Culture, Values, and Cooperation in AI Agents](https://arxiv.org/abs/2606.08274v1) | arXiv | The emergence of large language model (LLM)-based agents and multi-agent systems has enabled a shift from narrow task automation to more autonomous decision-making. Despite prog... |
| 2026-06-06 | [Macro Economists in the Machine: A Multi-Agent LLM Framework for Commodity-Related ETF Portfolio Construction](https://arxiv.org/abs/2606.08283v1) | arXiv | We test whether large language models (LLMs) add value in commodity portfolio construction when the information set and implementation rules are held fixed across strategies. A... |
| 2026-06-06 | [Decision-Aware Memory Cards: Counterfactual-Inspired Context Selection and Compression for Tool-Using LLM Agents](https://arxiv.org/abs/2606.08151v1) | arXiv | Tool-using LLM agents often fail not because relevant text is absent, but because decisive evidence is not selected, compressed, or surfaced at action time. We present CICL, a d... |
| 2026-06-08 | [InquiTree: Evaluating AI Agents in the Scientific Inquiry Loop with Paper-Derived Research Trees](https://arxiv.org/abs/2606.09550v1) | arXiv | While LLM-based agents are increasingly used in scientific workflows, it remains unclear whether they are truly qualified for the dynamic and uncertain process of discovery. Exi... |
| 2026-06-08 | [Civil Court Simulation with Large Language Models](https://arxiv.org/abs/2606.09632v1) | arXiv | Court simulation bridges legal education and judicial practice, yet human-based simulations are costly and difficult to scale. Large language models (LLMs) offer a scalable alte... |
| 2026-06-08 | [Bridging the Agent-World Gap: Text World Models for LLM-based Agents](https://arxiv.org/abs/2606.09032v1) | arXiv | Large language model (LLM)-based agents are increasingly used in interactive textual environments, from web navigation and code editing to tool use and long-horizon dialogue. Ye... |
| 2026-05-29 | [DynaTree: Dynamic Agentic Retrieval Tree for Time-Sensitive News Retrieval](https://arxiv.org/abs/2605.31377v1) | arXiv | Agentic Retrieval-Augmented Generation improves retrieval by integrating planning, tool use, and iterative reasoning, but existing agentic RAG methods often couple semantic expa... |
| 2026-06-07 | [Distilling LLM Reasoning into an Interpretable Policy Tree for Human-AI Collaboration](https://arxiv.org/abs/2606.08596v1) | arXiv | Constructing efficient and reliable policies to assist humans is indispensable for human-AI collaboration. Existing methods mainly follow two lines of work. Most prior work reli... |
| 2026-06-08 | [Baichuan-M4: A Clinical-Grade Medical Agent System for Continuous Care](https://arxiv.org/abs/2606.08982v1) | arXiv | Baichuan-M4 is Baichuan Intelligence's clinical-grade medical large model, designed for \emph{continuous care} rather than single-turn medical question answering. It is built as... |

### Cases and tutorials

| Date | Resource | Source | Why It Matters |
|---|---|---|---|
| 2026-06-05 | [Securing CI/CD in an agentic world: Claude Code Github action case - Microsoft](https://news.google.?oc=5) | Microsoft | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-08 | [How Async AI Agent Workflows Survive Failures - Augment Code](https://news.google.com/rss/articles/CBMia0FVX3lxTE9QVkhfWTBOSHFETXk2eGh6ejcyN21yWXk5dU91NEQ5QTRfaW43MTdIQkF5M2NrM1BRZllNQnNsY0NLaDgtS2psQm1YUXhPZ1lZVS11MUpUdjJIUjg4T1ROZUptdS1ab1g5R1pN?oc=5) | Augment Code | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-05 | [Dropbox Introduces Nova, an Internal Platform for Running AI Coding Agents at Scale - infoq.com](https://news.google.com/rss/articles/CBMic0FVX3lxTE1oRE9Ga0VEZmdoRE5oTFh6TklPZTgwdXdPODRUNXBjaDBzTzRhUW96dTBrVkh3UTVibmRQQ3N2WW5jWTVfQmZmTGxuU3J4OWk4NENBalI1X2lMWUJSQlNETDJ4WTV5RlduYU9VUWY5V1AwVG8?oc=5) | infoq.com | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-05 | [How ASUS Is Bringing AI into Healthcare Workflows - ASUS Pressroom](https://news.google.com/rss/articles/CBMikgFBVV95cUxObVowbHdYX0ZudnJmMzBOaVFsTVpPd2xVd0c1QW1tYUpPUktOcU9tMnRjZGc2em1sVFNxdjNRQmxRRkh4X3A2ekVfX3lpVmNVWTN4RFpiUkN1VnVDRm1vMlJIR3hpVzZZV2JZaWNWVElLODJydFkxUjFwamhZMDNvY1Vtd0pOWFZFNVVkTFhLWHU2QQ?oc=5) | ASUS Pressroom | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-03 | [CoCoEvolve: Evolutionary Optimization for AI Systems - Snowflake](https://news.google.com/rss/articles/CBMikAFBVV95cUxQOEEtcm5nRVF3b0RXc2dBeU5Fbk1RaG03TE5rWHg5MlRSTzR1a1VnRVhmU3NLc0RzMmtCeTI0WndDQkUtRThOLXdJd3otbUxCdVJDQ0hRWjFUbmdMcHFweVJwUW5BaHhWaHhkR3g5RExUN1hxek5ObDI3cUI3c2pLWDVjODNZR2JWWWxFbWFvaVA?oc=5) | Snowflake | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-02 | [Deploy Self-Evolving Agents for Faster, More Secure Research with a Hermes Agent and NVIDIA NemoClaw - NVIDIA Developer](https://news.google.?oc=5) | NVIDIA Developer | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-01 | [How People Are Really Using AI in 2026 - Harvard Business Review](https://news.google.com/rss/articles/CBMib0FVX3lxTE1JSjI0RE9JcFdtbTRHY3hHRkZFT3A0SXNTa0w4TlZCc1hYSHdJSGExMXJFT0xyMVlGNTd6aVJJUnpOYnNNVld6OF9VTjBRSGZuVzc0enhTUDlVb2FYM1RYemRjNHZBVWxLa0pqNGw4UQ?oc=5) | Harvard Business Review | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-05-27 | [Coding agents in the social sciences - Anthropic](https://news.google.com/rss/articles/CBMickFVX3lxTFBZOVA5Z3pKZ1JzSHJXaFl0LWdSQlZfZWhGb3AtY1R3MExZRm9KS2dfRmNzTE1XR2VXdjlPMVh6U25SU2JmcXBZQjlnSWRreHM2SGZmTnpQVzRLQVFmVFQyOExiR2o5dFhSb3A2WVBmV2RzQQ?oc=5) | Anthropic | Recent coverage found by query: AI agent case study coding research workflow |
| 2026-06-03 | [NVIDIA Enables the Next Era Of Physical AI Research With Agent Skills For Autonomous Vehicles, Robotics And Vision AI - NVIDIA Blog](https://news.google.com/rss/articles/CBMieEFVX3lxTE1jRkxCNmpVM1doMjJ5YS13dkQyb0hKYnVFOWZKa1dKWjAtUHlOVGhGdmRObVBPSkJzb25NNF9HSEpGUnIzNnVwUjBIR19vTDgyTWRzNkZoRnNtdGtrVTdiSUVtLXFCLVpidmJQdmM3YWZLdV9PN0dYNg?oc=5) | NVIDIA Blog | Recent coverage found by query: AI agent benchmark paper |
| 2026-06-02 | [Building Structured Generative AI Evaluation at Enterprise Scale - Oracle Blogs](https://news.google.com/rss/articles/CBMiiAFBVV95cUxNa3BGNkhnMEE3Yk9qX0cwOHBzZ0hPclpQcGRjWXBwaHItdUhLSjluUVFlUWpUeHRzZWFfRlExZmxCTEVOXy1IS2U4R3lVRnVqWmVVZXZHQU5ndUJUbVJFZm92M19fMUYweHJiTEpsR1JIdmJQeUt1dTBmM21PeC04ZTVwZi1zcFR5?oc=5) | Oracle Blogs | Recent coverage found by query: AI agent benchmark paper |
| 2026-05-27 | [What Is Spec-Driven Development? A Complete Guide - Augment Code](https://news.google.com/rss/articles/CBMidEFVX3lxTE5ScmRVbElOZmwyeENzaUFyRXlFMWdWeUFCMGVBa0ptUjVXendpUGlFTDFkMXVsZURxdVMyZTcySTZWMThEN1UwTVgzQl9HSTRhZmx0VFJaN3RLNnVtWmhhZ0UzZDBhS0Y3UThOQVJHV0pxdUo3?oc=5) | Augment Code | Recent coverage found by query: AI agent benchmark paper |
| 2026-06-09 | [AI agents evaluate neuroscience data-to-discovery pipeline - Let's Data Science](https://news.google.com/rss/articles/CBMiogFBVV95cUxPQkdWRS1hWHJVM0lWRVNQN3Zxdm9MYmZQYjRpZnd3UGJPRDdDOEMwY1RWR1F1TGsxM2xVNW9Wa1ZhUTVCeVB3SDU4OFhFdHU3Y1BEeXNSRHA1VkUyRlREdWJoQjMzZ3F0a3BUSXlfeFN1OWV3RzF4dDZaNU5wdnQzVzViSVRxOV9Za19uN1l5cU5LMnRBbTN2UTJJejNLR01DZnc?oc=5) | Let's Data Science | Recent coverage found by query: AI agent benchmark paper |

<!-- AUTO_LATEST_RESOURCES_END -->
