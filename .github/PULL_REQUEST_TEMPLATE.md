...
- [ ] New content (case, tutorial, project, paper, news digest)
- [ ] New collection or domain guide
- [ ] Bug fix (broken link, outdated info, typo)
- [ ] Documentation update
- [ ] Index or structural update
- [ ] Other
...
<!-- Link any issues this PR closes: Closes #123 -->
